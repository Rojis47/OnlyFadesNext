...
// export default function CodeBeams() {
//   return (
...
export default function BGGrid() {
  return (
    <div
      ...
      className="absolute top-0 left-0 z-0 w-full h-full bg-scroll events-none "
    >
      <div className="absolute inset-0 top-0 bottom-0 left-0 right-0 z-0 bg-scroll events-none " />
      <Beams />
    </div>
  );
}
